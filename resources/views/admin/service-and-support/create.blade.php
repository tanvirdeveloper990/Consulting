...
@section('title','Add Service & Support')
            ...
            <div class="col-12">
                <div class="card shadow-lg rounded-3">
                    <div class="card-header d-flex justify-content-between">
                        <h5 class="mb-0">Add Service & Support</h5>
                        ...
                        <form id="form" method="POST" action="{{route('admin.services.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <textarea class=" summernote form-control" id="description" name="description" rows="4"></textarea>
                                </div>
