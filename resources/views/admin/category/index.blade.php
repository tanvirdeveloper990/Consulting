                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex gap-1">
                                                <a href="{{ route('admin.category.edit',$item->id) }}" class="btn btn-sm btn-info">
                                                ...
                                                <form id="delete-form-{{$item->id }}" action="{{ route('admin.category.destroy',$item->id) }}" method="POST" class="d-none">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
